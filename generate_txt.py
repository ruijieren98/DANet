...
def generate_txt(mode='train'):
    root_dir = '/content/vision_datasets/cityscapes/leftImg8bit/'
    ...
    with open('/content/vision_datasets/cityscapes/cityscapes_{}_list.txt'.format(mode), 'w+') as f:
    ...
    print("{} number: {}".format(mode, index))
